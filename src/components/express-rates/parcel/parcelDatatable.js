...
import { deleteExpressRatesParcelRedux } from "../../../actions/index";
          ...
          <div>
            <span
              ...
              onClick={() => {
                ...
                this.setState({ myData: data });
                console.log(row);
                this.props.deleteExpressRatesParcelRedux(row.original.Country);
...
export default connect(null, { deleteExpressRatesParcelRedux })(Datatable);
