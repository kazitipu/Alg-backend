...
import {
  uploadExpressRatesDocumentsRedux,
  updateExpressRatesDocumentsRedux,
} from "../../../actions/index";
...
class CreateDocumentModal extends Component {
  ...
  handleSubmit = async (event) => {
    ...
    if (this.props.singleLot === null) {
      await this.props.uploadExpressRatesDocumentsRedux(this.state);
      toast.success(`Successfully created rate for ${this.state.country}`);
    } else {
      await this.props.updateExpressRatesDocumentsRedux(this.state);
