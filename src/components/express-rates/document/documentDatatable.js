...
import { deleteExpressRatesDocumentsRedux } from "../../../actions/index";
          ...
          <div>
            <span
              ...
              onClick={() => {
                ...
                this.setState({ myData: data });
                console.log(row);
                this.props.deleteExpressRatesDocumentsRedux(
...
export default connect(null, { deleteExpressRatesDocumentsRedux })(Datatable);
